    ...
    <div class="max-w-7xl mx-auto px-6 py-8">
        <div class="glass-effect rounded-2xl shadow-xl overflow-hidden animate-fade-in">
            ...
            <div class="flex border-b border-gray-200">
                ...
                <a href="{{ route('admin.results') }}" class="px-6 py-4 tab-active font-semibold flex items-center gap-2">
            ...
            <div class="p-8">
                <h2 class="text-2xl font-bold mb-6 flex items-center gap-2">
                    <i class="fas fa-keyboard text-purple-600"></i>All Test Results
                </h2>
                        ...
                        <tbody>
                            @foreach ($results as $result)
                                <tr class="border-b border-gray-200 transition">
                                    ...
                                    <td class="px-6 py-4">
                                        <form method="POST" action="{{ route('admin.delete.result', $result->id) }}" class="inline" onsubmit="return confirm('Are you sure?');">
                                            @csrf
                                            @method('DELETE')
